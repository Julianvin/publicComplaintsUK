        ...
        <div class="space-y-6">
            @forelse ($reports as $index => $report)
                <div
                    ...
                    <div class="report-content hidden opacity-0 scale-down transition-opacity transition-transform duration-300"
                        id="content-{{ $index }}">
                        <div class="px-6 py-4">
                            <ul class="flex justify-between items-center mb-4 border-b border-gray-200">
                                <li class="tab-button px-4 py-2 cursor-pointer text-green-600 hover:text-green-800 font-medium"
