            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    <a href="/" class="flex ml-2 md:mr-24">
                        <img src="{{ asset('assets/image/wikrama-logo.png') }}" class="h-8 mr-3" alt="wikrama logo" />
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Staff
                            Dashboard</span>
                    </a>
                </div>
